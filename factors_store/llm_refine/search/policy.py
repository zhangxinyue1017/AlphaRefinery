...
class SearchPolicy:
    ...
    correlation_redundancy_weight: float = 0.10
    ...
    novelty_bonus_weight: float = 0.08
    motif_novelty_weight: float = 0.06
    ...
    def with_target_profile(self, target_profile: str) -> "SearchPolicy":
        ...
        if normalized == "raw_alpha":
            return replace(
                ...
                excess_return_weight=max(float(self.excess_return_weight), 0.7),
                sharpe_weight=min(float(self.sharpe_weight), 0.7),
    ...
    def from_preset(cls, preset: str = "balanced") -> "SearchPolicy":
        ...
        if normalized == "exploratory":
            return cls(
                ...
                sharpe_weight=0.82,
                turnover_penalty_weight=0.42,
                complexity_penalty_weight=0.018,
                depth_penalty_weight=0.04,
                branch_penalty_weight=0.18,
                redundancy_penalty_weight=0.1,
                family_motif_saturation_weight=0.09,
