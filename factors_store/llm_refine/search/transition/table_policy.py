...
SHADOW_STAGE_POLICY_TABLE: tuple[ShadowPolicyRule, ...] = (
    ...
    ShadowPolicyRule(
        rule_id="round_failed_reopen",
        phase="any",
        conditions=("last_round_status=failed",),
        action="reopen_broad",
    ...
    ShadowPolicyRule(
        ...
        parent_selection_bias="diversify_branch",
        confidence="low",
        reason="multiple candidate evaluation failures with no usable winner should reopen/repair",
    ),
    ShadowPolicyRule(
